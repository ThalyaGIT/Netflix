...
Action: I will group them into an "Others" category if count is less than 50
``` {r}
df <- df %>% 
    group_by(country) %>% 
    mutate(country = ifelse(n()>50, country, 'Others'))
```
...
For each Show/Movie, if there are points attached to at least one of the actors/actresses, I give the new variable cast_points the value "known", otherwise, it is labelled as "unknown".
```{r}
...
df = subset(df, select = -c(plot,google_plot))
...
3. Director : List of directors of the show
4. Cast: List of casts of the show
5. Country: List of countries relating to the show
6. Date Added: Date the show was put on Netflix
7. Release Year: Year the show was first released
8. Genre: List of genres of the show 
9. Plot: Description of the plot of the show
10. Google Score: Displayed on Google as the percentage of viewers that liked a show
11. Google Genre: Whether or not Genre is absent/present in the google search
12. Google Language: Whether or not Language is absent/present in the google search
13. Google Plot: Plot of the show according to Google
14. Duration Minutes: Duration of the movie in minutes
15. Duration Seasons: Durationg of the TV show in terms of how many seasons it has
16. Cast Points: Level of popularity of the most famous cast member of the show according to IMDB
17. Director Points: Level of popularity of the most famous director of the show according to IMDB
18. LSA category: Category of the show according to the LSA algorithm

Dependent Feature:
Google Score:

Independent Features:
Type, Date Added, Release Year, Google Genre, Google Language, Duration Minutes, Duration Seasons, Cast Points, Director Points, LSA Category

Features not directly for Analysis:
Title, Director, Cast, Country, Genre, Plot, Google Plot

### Among the Independent Features, What are the Categorical, discrete and continuous features 

Categorical: Type, LSA Category

Discrete: Date Added, Release Year, Google Genre, Google Language, Duration Seasons

Continuous: Duration Minutes, Cast Points, Director Points

### Distribution of the features

```{r echo=FALSE, out.width = '50%'}
knitr::include_graphics("Type Distribution.JPG")
```
```{r echo=FALSE, out.width = '50%'}
knitr::include_graphics("DirectorDist.JPG")
```
```{r echo=FALSE, out.width = '50%'}
knitr::include_graphics("CastDist.JPG")
```
```{r echo=FALSE, out.width = '50%'}
knitr::include_graphics("DateAddedDist.JPG")
```

<iframe src=" https://public.tableau.com/views/DistributionNetflix/TypeDist?:language=en-US&publish=yes&:display_count=n&:origin=viz_share_link:showVizHome=no&:embed=true"
